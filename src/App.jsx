...
export default function ConecteLanding() {
  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-zinc-950/90 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 text-sm font-medium">
            {navLinks.map((l) => (
              <a key={l.href} href={l.href} className="hover:text-[#ffde59] transition">
                {l.label}
              </a>
            ))}
          </div>
              ...
              <div className="flex flex-col px-6 py-4 gap-4">
                {navLinks.map((l) => (
                  <a
                    ...
                    className="text-lg font-medium hover:text-[#ffde59] transition py-1"
                  >
                    {l.label}
                  </a>
                ))}
      ...
      {/* Diferenciais */}
      <section id="diferenciais" className="py-20 bg-zinc-950">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="text-4xl font-bold">Por que escolher a Conecte?</h2>
            <p className="text-zinc-400 mt-3">Mais do que internet — uma empresa que vive onde você vive</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-zinc-900 border border-white/10 rounded-3xl p-8 hover:border-[#ffde59]/40 transition"
              >
                <div className="mb-4">{d.icon}</div>
                <h3 className="text-xl font-bold mb-2">{d.titulo}</h3>
                <p className="text-zinc-400 text-sm leading-relaxed">{d.texto}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* Estatísticas */}
      <section className="py-16 bg-[#0a7ee2]">
            ...
            {plans.map((p, i) => (
              <motion.div
                ...
                className={`rounded-3xl p-8 border transition-all ${
                  p.destaque ? "border-[#ffde59] bg-zinc-900 scale-105" : "border-white/10"
                }`}
              >
                {p.destaque && (
                ...
                <div className="text-center">
                  ...
                  <span className="text-3xl text-zinc-400"> Mbps</span>
                </div>
      ...
      <section id="cobertura" className="py-20 bg-zinc-900">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-zinc-400 mb-10">Toda a região com fibra óptica 100%</p>
          ...
          <input
            ...
            className="w-full max-w-md mx-auto block bg-zinc-800 border border-white/10 rounded-2xl px-6 py-4 text-lg focus:outline-none focus:border-[#ffde59]"
          />
          <button
            onClick={() =>
      ...
      <section id="sobre" className="py-24 bg-zinc-950">
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3 bg-zinc-900 rounded-2xl p-4">
          ...
          <p className="text-zinc-600 text-xs mt-8">* Sujeito à disponibilidade de técnico.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-zinc-400 mt-3">Pessoas reais de Arroio do Sal</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-zinc-950 border border-white/10 rounded-3xl p-6 hover:border-white/20 transition"
              >
                ...
                <p className="text-zinc-300 leading-relaxed mb-6">"{d.texto}"</p>
                <div>
                  <div className="font-semibold">{d.nome}</div>
                  <div className="text-zinc-500 text-sm">{d.bairro}</div>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2 text-zinc-400 text-sm">
                ...
                <span className="text-zinc-600 text-xs mt-2">CNPJ: XX.XXX.XXX/0001-XX</span>
              </div>
            </div>
          </div>

          <div className="border-t border-white/10 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center gap-3 text-zinc-600 text-xs">
